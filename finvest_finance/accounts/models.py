...
class Transactions(models.Model):
    user = models.ForeignKey(User, on_delete=models.CASCADE, related_name='transactions')  # Referenc
    stock = models.ForeignKey(StockData, on_delete=models.CASCADE, related_name='transactions')
    quantity = models.PositiveIntegerField()  # Quantity of the stock bought or sold
    purchase_price = models.DecimalField(max_digits=10, decimal_places=2)  # Price at
...
class CustomUser(AbstractUser):
    ...
    pan_card_number = models.CharField(max_length=10, unique=True, blank=True, null=True)
